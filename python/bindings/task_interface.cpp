    ...
    nb::class_<ChipWorker>(m, "_ChipWorker")
        ...
        .def(
            ...
            [](ChipWorker &self, uint64_t comm_handle, uint64_t allocation_id, const std::vector<uint32_t> &rank_ids,
               uint32_t domain_rank, size_t window_size, uint64_t commit_flag_address, uint32_t engine_mask) {
                ...
                auto [device_ctx, local_window_base] = self.comm_alloc_domain_windows(
                    comm_handle, allocation_id, rank_ids, domain_rank, window_size, engine_mask
                );
                __atomic_store_n(
            ...
            nb::arg("window_size"), nb::arg("commit_flag_address"), nb::arg("engine_mask") = 0,
            ...
            "engine_mask is a bitmask of DmaWorkspaceKind values this domain will use."
        )
        .def(
